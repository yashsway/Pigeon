...
<body>
<nav class="ym-hlist" id="nav_bar">
    <ul class="list_no_style">
        <li>
            <h2 class="nav-title nav-element" id="nav-title">Pigeon</h2>
        </li>
    </ul>
    <a href="#" class="btn nav-buttons btn-danger" id="logout"><span class="btn-icons glyphicon glyphicon-off"></span><span class="text">&nbsp;Logout</span></a>
    <a href="#" class="btn nav-buttons btn-success" id="report"><span class="btn-icons glyphicon glyphicon-plus"></span><span class="text">&nbsp;Report</span></a>
</nav>
<div class="container-fluid">
    <div class="col-md-12 col-sm-12 main-panel-container">
        ...
        <table class="table main-panel">
            <thead>
                <tr>
                <th class="main-panel-header-contents" colspan="6">Client</th>
                <th class="main-panel-header-contents" colspan="3">Administrator</th>
                </tr>
                <tr>
                <th class="main-panel-header-contents"><img src="assets/icons/hammer.png" data-toggle="tooltip" data-placement="top" title="Resolved?"/><br/><center>Resolved?</center>
                </th>
                <th class="main-panel-header-contents"><img src="assets/icons/info.png" data-toggle="tooltip" data-placement="top" title="ID"/><br/><center>ID</center>
                </th>
                <th class="main-panel-header-contents"><img src="assets/icons/clipboard.png" data-toggle="tooltip" data-placement="top" title="Summary"/><br/><center>Summary</center>
                </th>
                <th class="main-panel-header-contents"><img src="assets/icons/calendar_month.png" data-toggle="tooltip" data-placement="top" title="Date Due"/><br/><center>Date Due</center>
                </th>
                <th class="main-panel-header-contents"><img src="assets/icons/clock.png" data-toggle="tooltip" data-placement="top" title="Time Due"/><br/><center>Time Due</center>
                </th>
                <th class="main-panel-header-contents"><img src="assets/icons/risk.png" data-toggle="tooltip" data-placement="top" title="Client Priority"/><br/><center>Client Priority</center>
                </th>

                <th class="main-panel-header-contents"><img src="assets/icons/ambulance.png" data-toggle="tooltip" data-placement="top" title="Your Priority"/><br/><center>Your Priority</center>
                </th>
                <th class="main-panel-header-contents"><img src="assets/icons/tag.png" data-toggle="tooltip" data-placement="top" title="Tag (Click to Update)"/><br/><center>Tag</center>
                </th>
                <th class="main-panel-header-contents"><img src="assets/icons/gear.png" data-toggle="tooltip" data-placement="top" title="Tools"/><br/><center>Tools</center>
                </th>
                </tr>
            </thead>
