            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="department_container">
                                <span class="fa fa-building fa-lg full-info-icons"></span>
                        ...
                        <div class="col-md-12">
                            <div class="request_container">
                                <span class="fa fa-life-ring fa-lg full-info-icons"></span>
                        ...
                        <div class="col-md-12">
                            <div class="details_container">
                                <span class="fa fa-file-text fa-lg full-info-icons"></span>
                                <br/>
                        ...
                        <div class="col-md-6">
                            <div class="priority_container">
                                <span class="fa fa-exclamation-triangle fa-lg full-info-icons"></span>
                    ...
                    <div class="row" id="adminDetailsSection">
                        ...
                        <div class="col-md-12">
                            <div>
                                <span class="fa fa-thumb-tack fa-2x" id="adminDetailsSection_icon"></span>
                            </div>
                        </div>
                        <div class="col-md-6 paperBackground">
                            <div class="adminPriority_container">
                                <span class="">
                                    <span class="fa fa-bell-o fa-lg full-info-icons"></span>
                                    <p class="full-info-text adminPriority">Are you cray?</p>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-6 paperBackground">
                            <div class="duration_container">
                                <span class="fa fa-rocket fa-lg full-info-icons"></span>
                                <p class="full-info-text duration">Seriously.</p>
                            </div>
                        </div>
                        <div class="col-md-12 paperBackground">
                            <div class="notes_container">
                                <span class="fa fa-tags fa-lg full-info-icons"></span>
